        ...
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('store.type') }}" method="post" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="type_name" class="form-control" id="input1"  >
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group col-md-12">
                    <label for="input3" class="form-label">Type Description </label>
                    <textarea name=" description"  class="form-control" id="input3" placeholder="Description ..." rows="3"></textarea>
                </div>
