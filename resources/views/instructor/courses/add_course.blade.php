...
<div id="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <div class="form-group col-md-3">
                <label for="input2" class="form-label">Duration online </label>
                <input type="text" name="duration online" class="form-control" id="input2"  >
            </div>
            <div class="form-group col-md-3">
                <label for="input3" class="form-label">Duration offline </label>
                <input type="text" name="duration offline" class="form-control" id="input3"  >
            </div>
