...
<body class="">
	...
	<div class="wrapper">
     ...
     <form class="row g-3" method="POST" action="{{ route('login') }}">
            ...
            <div class="col-12">
                <label for="inputEmailAdress" class="form-label">Email</label>
                <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmailAdress" placeholder="jhon@example.com">
                @error('email')
            ...
            <div class="col-12">
                <div class="text-center ">
                    <p class="mb-0">Don't have an account yet? <a href="sign.up">Sign up here</a>
                    </p>
                </div>
            </div>
        </form>
