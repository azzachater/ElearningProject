...
<div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
    <div class="lecture-overview-wrap">
        <div class="lecture-overview-item">
            ...
            @if ($course !== null && $course->course !== null && $course->course->course_title !== null)
            ...
            <div class="lecture-overview-stats-wrap d-flex">
                ...
                <div class="lecture-overview-stats-item">
                    <ul class="generic-list-item">
                        @if ($course !== null && $course->course !== null && isset($course->course->label))
                ...
                <div class="lecture-overview-stats-item">
                    <ul class="generic-list-item">
                        @if ($course !== null && $course->course !== null && isset($course->course->resources))
                        <li><span>Resource:</span>{{ $course->course->resources }}</li>
                    @endif
                    
                    @if ($course !== null && $course->course !== null)
                    <li><span>Video length:</span>{{ $course->course->duration ?? 'N/A' }} total hours</li>
                    <li><span>Certificate:</span>{{ $course->course->certificate ?? 'N/A' }}</li>
                @endif
        ...
        <div class="lecture-overview-item">
            <div class="lecture-overview-stats-wrap d-flex">
                ...
                <div class="lecture-overview-stats-item lecture-overview-stats-wide-item lecture-description">
                    ...
                    @if ($course !== null && $course->course !== null && isset($course->course->description))
    ...
    <div class="lecture-overview-wrap lecture-quest-wrap">
        <div class="new-question-wrap">
            ...
            <div class="new-question-body pt-40px">
                ...
                @if ($course !== null && isset($course->instructor_id))
        ...
        <div class="question-overview-result-wrap">
            ...
            <div class="lecture-overview-item mt-0">
                <div class="question-list-item">
                    @php
                    $id = Auth::user()->id;
                    // Assurez-vous d'obtenir l'objet $course correctement dans votre contexte
                    // Par exemple, si vous l'obtenez à partir de votre modèle, utilisez la logique appropriée pour l'obtenir
                    $course = null; // Assurez-vous de définir $course avec la logique appropriée pour votre application
                @endphp
                ...
                @endforeach
            @else
                <!-- Gérer le cas où $question est null -->
                <!-- Par exemple, afficher un message indiquant qu'il n'y a pas de questions -->
            @endif
