                ...
                <div class="sidebar sidebar-negative">
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            // Check if selling_price is set and not zero to avoid division by zero
                            if (isset($course->selling_price) && $course->selling_price != 0) {
    ...
    <div class="container">
        <div class="related-course-wrap">
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                ...
                // Check if selling_price is set and not zero to avoid division by zero
                if (isset($inscourse->selling_price) && $inscourse->selling_price != 0) {
                    // Calculate the amount
                ...
                <div class="preview-course-feature-content pt-40px">
                    <p class="d-flex align-items-center pb-2">
                        @if ($inscourse->discount_price == NULL)
                            <span class="fs-35 font-weight-semi-bold text-black">${{ $inscourse->selling_price }}</span>
                        @else
                            <span class="fs-35 font-weight-semi-bold text-black">${{ $inscourse->discount_price }}</span>
                            <span class="before-price mx-1">${{ $inscourse->selling_price }}</span>
                            @if (isset($inscourse->selling_price) && $inscourse->selling_price != 0)
                                <span class="discount-percentage">({{ number_format($discount, 2) }}% off)</span>
                            @endif
                        @endif
