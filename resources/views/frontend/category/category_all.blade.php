     ...
     <div class="col-lg-6 responsive-column-half">
         <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
             <div class="card-image">
                 ...
                 // Check if selling_price is not zero to avoid division by zero
                 if ($course->selling_price != 0) {
                     // Calculate the discount percentage
                     $discount = ($amount / $course->selling_price) * 100;
                 } else {
                     // Handle the case where selling_price is zero (e.g., set discount to 100% or another appropriate value)
                     $discount = 100; // Or any other logic you want to apply
                 }
             @endphp
