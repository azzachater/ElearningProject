...
class CourseController extends Controller
{
    ...
    public function StoreCourse(Request $request){
        try {
            $request->validate([
                'video' => 'required|mimes:mp4|max:10000000000',
            ...
            if ($request->file('course_image')) {
                ...
                Image::make($image)->resize(370, 246)->save(public_path('upload/course/thambnail/'.$name_gen));
                $save_url = 'upload/course/thambnail/'.$name_gen;
            } else {
                return back()->withErrors(['course_image' => 'Please select a course image to upload.']);
            }
            ...
            $course_id = Course::insertGetId([
                ...
                'duration_online' => $request->duration_online,
                'duration_offline' => $request->duration_offline,
    ...
    public function DeleteCourse($id)
    {
        ...
        if ($course) {
            // Check if the course image file exists and delete it
        ...
        // If the course was not found, set an error notification
        $notification = array(
